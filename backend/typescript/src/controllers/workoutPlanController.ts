...
import type { WorkoutPlanDay, WorkoutPlanItem } from "../types/api.js";
import {
  parsePositivePathID,
  requireString,
...
export async function listWorkoutPlanDays(_req: Request, res: Response) {
...
export async function createWorkoutPlanDay(req: Request, res: Response) {
...
export async function deleteWorkoutPlanDay(req: Request, res: Response) {
...
export async function createWorkoutPlanItem(req: Request, res: Response) {
  const dayID = parsePositivePathID(req, "id", "day id");
...
export async function deleteWorkoutPlanItem(req: Request, res: Response) {
  const dayID = parsePositivePathID(req, "id", "day id");
